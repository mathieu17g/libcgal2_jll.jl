# Autogenerated wrapper script for libcgal2_julia_jll for x86_64-apple-darwin
export libcgal_julia_exact, libcgal_julia_inexact

using CGAL2_jll
using libcxxwrap_julia_jll
JLLWrappers.@generate_wrapper_header("libcgal2_julia")
...
function __init__()
    JLLWrappers.@generate_init_header(CGAL2_jll, libcxxwrap_julia_jll)
